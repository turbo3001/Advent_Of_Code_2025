...
#include "Day_4/Day4Processor.hpp"
...
int main(const int ArgC, const char* ArgV[]) {
	...
	switch (DayNumber) {
		...
		case 4:
		{
			Processor = new Day4Processor(InputFileName);
		}
			break;
		case 5:
		{
			Processor = new Day5Processor(InputFileName);
		}
			break;
	        case 6:
	        {
	          Processor = new Day6Processor(InputFileName);
	        }
	        break;
		default:
